...
Pod::Spec.new do |s|
  ...
  s.name         = "MVPCocoa"
  s.version      = "1.0.0"
  s.summary      = "MVPCocoa, is library that implements, Model-View-Presenter architecture for iOS framework."
...
MVP architecture implementation basic and needs for iOS framework to create valid applications for swift 4.2
  ...
  s.source       = { :git => "https://github.com/droideveloper/MVPCocoa.git", :branch => 'master' }
